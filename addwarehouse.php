...
if (!isset($_SESSION['logged'])) {
    ...
    if (isset($_POST['wh_name'])) {
        ...
        if ($connection->connect_errno != 0) {
            ...
            if ($connection->query("INSERT INTO warehouses VALUES (NULL,'$wh_name', '$type', '$wh_description', '$id_user')")) {
...
<div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span
                                class="glyphicon glyphicon-user"></span> Logged as: <?php echo $_SESSION['username'] ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <br/>
            <form action="delete_db_wh.php" class="form-custom" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    if ($connection->connect_errno != 0) {
                        ...
                        if ($result = $connection->query("SELECT w.id, w.name, w.type, w.description, users.username as owner FROM warehouses w JOIN users ON users.id=w.id_user WHERE id_user='$id_user' ORDER BY id ASC")) {
